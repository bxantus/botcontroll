...
public class ScheduleService extends JobService implements BotController.IComnmandCompleted {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        BotLog.addLine(this, String.format("Executing press Job for '%s'", name));
    ...
    public void onCommandCompleted(boolean success) {
        if (runningJob != null) {
            ...
            runningJob = null;
            Log.i(TAG, "Job finished! " + success);
            BotLog.addLine(this, String.format("Job finished %b!", success));
        }
    }
}
